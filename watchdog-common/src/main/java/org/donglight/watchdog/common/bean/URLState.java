...
@Data
@Builder
public final class URLState implements Serializable {
     ...
     * 当前url被访问失败次数
     */
    private final int currentFailTimes;
    ...
    private URLState(URLState.Builder builder) {
        ...
        this.currentFailTimes = builder.currentFailTimes != null ? builder.currentFailTimes : 0;
    }
    ...
    public static final class Builder {
        ...
        public Integer currentFailTimes;
        ...
        public Builder(URLState source) {
            ...
            this.currentFailTimes = source.currentFailTimes;
        }
        ...
        *//**
        ...
        public URLState.Builder currentFailTimes(int currentFailTimes) {
            this.currentFailTimes = currentFailTimes;
            return this;
        }
    ...
    public int compareTo(URLState o) {
        ...
        if (this.currentConcurrency != o.currentConcurrency) {
            return this.currentConcurrency > o.currentConcurrency ? 1 : -1;
        }
        if (this.currentFailTimes != o.currentFailTimes) {
            return this.currentFailTimes > o.currentFailTimes ? 1 : -1;
        }
        return 0;
    }
    ...
    public boolean equals(Object o) {
        if (o == this) {
            ...
            return (this.id == that.id)
                    ...
                    && (this.currentFailTimes == that.currentFailTimes)
    ...
    public int hashCode() {
        ...
        result = 31 * result + currentFailTimes;
        return result;
    }*/
}
